export const FaqsList = [
  {
    title: 'Why should I use Trawler instead of integrating directly with data providers?',
    text: `Absolutely. At Quiltt, security is our top priority. We employ industry-leading encryption, secure authentication protocols, and adhere to the highest standards of data protection. Your data is always safe and secure with us.`,
  },
  {
    title: 'Is my data secure with Trawler?',
  ...
  {
    title: 'What aggregators and enrichment providers does Trawler support?',
  ...
  {
    title: 'Do I need my own API keys from the data providers?',
  ...
  {
    title: "How does Trawler's pricing work?",
    text: `Raw transactional data often lacks clarity and context for financial providers and consumers. Trawler’s data enhancement services deliver verified, enriched financial data to improve experiences, drive growth, and support better decision-making.`,
  },
  {
    title: 'What platforms and technologies does Trawler support?',
